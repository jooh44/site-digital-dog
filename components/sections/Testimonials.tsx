...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: 'Chegamos à 1ª posição no Google e nossos agendamentos aumentaram 110%. O reposicionamento da marca foi um divisor de águas para a Aumivet.',
    photo: '/images/testimonials/aumivet-avatar.jpg',
  ...
  {
    id: 2,
    quote: 'A estratégia de SEO Local foi agressiva e funcionou muito bem. Hoje somos Top 1 em SJP e tivemos um aumento de 150% na procura.',
    photo: '/images/testimonials/morgan-ted-avatar.jpg',
    name: 'Dr. Ricardo Morgan',
    clinic: 'Morgan & Ted',
    rating: 5,
  },
  {
    id: 3,
    quote: 'O redesign focado em UX e a gestão de tráfego trouxeram um ROAS de 40x. O faturamento cresceu mais de 100k/mês. Resultados impressionantes.',
    photo: '/images/testimonials/rzvet-avatar.jpg',
    name: 'Dr. Roberto Zanetti',
    clinic: 'RZ VET',
    rating: 5,
  },
  {
    id: 4,
    quote: 'O sistema de agendamento online facilitou muito nossa operação domiciliar. Nossos clientes adoram a facilidade do novo site.',
    photo: '/images/testimonials/vet-em-casa-avatar.jpg',
    name: 'Dra. Carla Dias',
    clinic: 'Vet em Casa',
    rating: 5,
  },
