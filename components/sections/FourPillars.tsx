...
const pillars: Pillar[] = [
  {
    ...
    description: 'A "recepção digital" da sua clínica. Apresente corpo clínico, especialidades e infraestrutura com autoridade e velocidade. Layout responsivo e otimizado.',
  },
  {
    id: 2,
    icon: TrendingUp,
    title: 'Landing Pages de Campanha',
    description: 'Páginas focadas em conversão imediata. Ideais para campanhas de Google Ads (Castração, Vacinas, Check-ups). Design feito para vender.',
  },
  {
    id: 3,
    icon: Brain,
    title: 'Sistemas Sob Medida',
    description: 'Precisa de um agendamento online específico ou área do tutor? Desenvolvemos soluções personalizadas que softwares prontos de mercado não entregam.',
  },
  {
    id: 4,
    icon: Network,
    title: 'O Diferencial (Selo de Qualidade)',
    description: 'Tudo construído sob os pilares da Arquitetura Digital: código limpo, SEO técnico já incluso e infraestrutura pronta para escalar seu negócio.',
  },
]

export function FourPillars() {
  return (
    <section id="servicos" className="relative py-20 md:py-32 px-4 bg-darker-blue overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="font-body text-light-blue text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Soluções completas para posicionar sua clínica como referência.
          </p>
        </motion.div>
